      ...
      <li className="nav-li">
        <a
          ...
          onClick={(e) => {
            ...
            onContactClick(); // Trigger scroll to bottom
          }}
        >
          Contact
        </a>
...
const Navbar = () => {
  ...
  const contactRef = useRef(null); // Create a ref for the bottom of the page
  ...
  return (
    <>
        ...
        <div className="mx-auto c-space max-w-7xl">
          <div className="flex items-center justify-between py-2 sm:py-0">
            ...
            <nav className="hidden sm:flex">
              <Navigation onContactClick={scrollToBottom} />
            </nav>
          </div>
        </div>
        {isOpen && (
      ...
      {/* Add a div at the bottom of the page to scroll to */}
      <div ref={contactRef} className="h-16"></div>
    </>
  );
};
